...
//go:generate minimock -i github.com/Iusemywalk88/microservice_course/chat-server/internal/repository.ChatRepository -o chat_repository_minimock.go -n ChatRepositoryMock -p mocks
...
type ChatRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, req *model.Chat) (i1 int64, err error)
	funcCreateOrigin    string
	inspectFuncCreate   func(ctx context.Context, req *model.Chat)
...
func (mmCreate *mChatRepositoryMockCreate) Expect(ctx context.Context, req *model.Chat) *mChatRepositoryMockCreate {
	...
	mmCreate.defaultExpectation.params = &ChatRepositoryMockCreateParams{ctx, req}
...
// ExpectReqParam2 sets up expected param req for ChatRepository.Create
func (mmCreate *mChatRepositoryMockCreate) ExpectReqParam2(req *model.Chat) *mChatRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mChatRepositoryMockCreate) Inspect(f func(ctx context.Context, req *model.Chat)) *mChatRepositoryMockCreate {
...
func (mmCreate *mChatRepositoryMockCreate) Set(f func(ctx context.Context, req *model.Chat) (i1 int64, err error)) *ChatRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mChatRepositoryMockCreate) When(ctx context.Context, req *model.Chat) *ChatRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatRepositoryMock.Create mock is already set by Set")
	}
	...
	expectation := &ChatRepositoryMockCreateExpectation{
		mock:               mmCreate.mock,
		params:             &ChatRepositoryMockCreateParams{ctx, req},
...
func (mmCreate *ChatRepositoryMock) Create(ctx context.Context, req *model.Chat) (i1 int64, err error) {
	...
	mm_params := ChatRepositoryMockCreateParams{ctx, req}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := ChatRepositoryMockCreateParams{ctx, req}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.req != nil && !minimock.Equal(*mm_want_ptrs.req, mm_got.req) {
				mmCreate.t.Errorf("ChatRepositoryMock.Create got unexpected parameter req, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmCreate.t.Fatalf("Unexpected call to ChatRepositoryMock.Create. %v %v", ctx, req)
	return
}
