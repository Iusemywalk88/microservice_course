...
//go:generate minimock -i github.com/Iusemywalk88/microservice_course/chat-server/internal/service.ChatService -o chat_service_minimock.go -n ChatServiceMock -p mocks
...
func (mmCreate *mChatServiceMockCreate) Expect(ctx context.Context, req *model.Chat) *mChatServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &ChatServiceMockCreateParams{ctx, req}
...
// ExpectReqParam2 sets up expected param req for ChatService.Create
func (mmCreate *mChatServiceMockCreate) ExpectReqParam2(req *model.Chat) *mChatServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mChatServiceMockCreate) Inspect(f func(ctx context.Context, req *model.Chat)) *mChatServiceMockCreate {
...
func (mmCreate *mChatServiceMockCreate) Set(f func(ctx context.Context, req *model.Chat) (i1 int64, err error)) *ChatServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mChatServiceMockCreate) When(ctx context.Context, req *model.Chat) *ChatServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &ChatServiceMockCreateExpectation{
		mock:               mmCreate.mock,
		params:             &ChatServiceMockCreateParams{ctx, req},
...
func (mmCreate *ChatServiceMock) Create(ctx context.Context, req *model.Chat) (i1 int64, err error) {
	...
	mm_params := ChatServiceMockCreateParams{ctx, req}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := ChatServiceMockCreateParams{ctx, req}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.req != nil && !minimock.Equal(*mm_want_ptrs.req, mm_got.req) {
				mmCreate.t.Errorf("ChatServiceMock.Create got unexpected parameter req, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmCreate.t.Fatalf("Unexpected call to ChatServiceMock.Create. %v %v", ctx, req)
	return
}
