...
//go:generate minimock -i github.com/Iusemywalk88/microservice_course/auth/internal/service.AuthService -o auth_service_minimock.go -n AuthServiceMock -p mocks
...
func (mmCreate *mAuthServiceMockCreate) Expect(ctx context.Context, req *model.User) *mAuthServiceMockCreate {
...
// ExpectReqParam2 sets up expected param req for AuthService.Create
func (mmCreate *mAuthServiceMockCreate) ExpectReqParam2(req *model.User) *mAuthServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mAuthServiceMockCreate) Inspect(f func(ctx context.Context, req *model.User)) *mAuthServiceMockCreate {
...
func (mmCreate *mAuthServiceMockCreate) Set(f func(ctx context.Context, req *model.User) (i1 int64, err error)) *AuthServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mAuthServiceMockCreate) When(ctx context.Context, req *model.User) *AuthServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *AuthServiceMock) Create(ctx context.Context, req *model.User) (i1 int64, err error) {
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.req != nil && !minimock.Equal(*mm_want_ptrs.req, mm_got.req) {
				mmCreate.t.Errorf("AuthServiceMock.Create got unexpected parameter req, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (mmUpdate *mAuthServiceMockUpdate) Expect(ctx context.Context, user *model.UpdateUserInfo) *mAuthServiceMockUpdate {
...
func (mmUpdate *mAuthServiceMockUpdate) ExpectUserParam2(user *model.UpdateUserInfo) *mAuthServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mAuthServiceMockUpdate) Inspect(f func(ctx context.Context, user *model.UpdateUserInfo)) *mAuthServiceMockUpdate {
...
func (mmUpdate *mAuthServiceMockUpdate) Set(f func(ctx context.Context, user *model.UpdateUserInfo) (err error)) *AuthServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mAuthServiceMockUpdate) When(ctx context.Context, user *model.UpdateUserInfo) *AuthServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *AuthServiceMock) Update(ctx context.Context, user *model.UpdateUserInfo) (err error) {
