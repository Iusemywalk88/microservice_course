...
//go:generate minimock -i github.com/Iusemywalk88/microservice_course/auth/internal/repository.AuthRepository -o auth_repository_minimock.go -n AuthRepositoryMock -p mocks
...
type AuthRepositoryMock struct {
	...
	funcUpdate          func(ctx context.Context, user *model.UpdateUserInfo) (err error)
	funcUpdateOrigin    string
	inspectFuncUpdate   func(ctx context.Context, user *model.UpdateUserInfo)
...
func (mmCreate *mAuthRepositoryMockCreate) Expect(ctx context.Context, req *model.User) *mAuthRepositoryMockCreate {
...
// ExpectReqParam2 sets up expected param req for AuthRepository.Create
func (mmCreate *mAuthRepositoryMockCreate) ExpectReqParam2(req *model.User) *mAuthRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mAuthRepositoryMockCreate) Inspect(f func(ctx context.Context, req *model.User)) *mAuthRepositoryMockCreate {
...
func (mmCreate *mAuthRepositoryMockCreate) Set(f func(ctx context.Context, req *model.User) (i1 int64, err error)) *AuthRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mAuthRepositoryMockCreate) When(ctx context.Context, req *model.User) *AuthRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *AuthRepositoryMock) Create(ctx context.Context, req *model.User) (i1 int64, err error) {
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.req != nil && !minimock.Equal(*mm_want_ptrs.req, mm_got.req) {
				mmCreate.t.Errorf("AuthRepositoryMock.Create got unexpected parameter req, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (mmUpdate *mAuthRepositoryMockUpdate) Expect(ctx context.Context, user *model.UpdateUserInfo) *mAuthRepositoryMockUpdate {
...
func (mmUpdate *mAuthRepositoryMockUpdate) ExpectUserParam2(user *model.UpdateUserInfo) *mAuthRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mAuthRepositoryMockUpdate) Inspect(f func(ctx context.Context, user *model.UpdateUserInfo)) *mAuthRepositoryMockUpdate {
...
func (mmUpdate *mAuthRepositoryMockUpdate) Set(f func(ctx context.Context, user *model.UpdateUserInfo) (err error)) *AuthRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mAuthRepositoryMockUpdate) When(ctx context.Context, user *model.UpdateUserInfo) *AuthRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *AuthRepositoryMock) Update(ctx context.Context, user *model.UpdateUserInfo) (err error) {
